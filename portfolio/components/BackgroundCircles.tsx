...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#64ffd9] opacity-40 rounded-full h-[650px] w-[650px] mt-52 animate-ping" />
      <div className="absolute border border-[#1f2f4d] rounded-full h-[800px] w-[800px] mt-52 animate-ping" />
    </motion.div>
  );
}
